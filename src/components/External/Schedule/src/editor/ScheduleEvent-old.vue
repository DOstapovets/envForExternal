...
<div class="schedule-step">
    ...
    <div class="wr-start-date">
      <div class="choose-date choose-date_start">
        ...
        <span v-else class="schedule-step__start-date">{{startDateUi}}</span>
      </div>
  ...
  methods: {
    ...
    getDailyCronExpressions() {
      ...
      if (
        ...
        console.log('getDailyCronExpressions');
        console.log(!this.daily);
        console.log(!this.dailySchedule.isDailyDaysValid);
        console.log(!this.dailySchedule.isDailyRepeatTimeValid);
        console.log(this.dailyPeriodMode === 'everyDay' && !this.daily.days);
        console.log(this.dailyPeriodMode === 'everyDay');
        console.log(this.daily.days);
        console.log('getDailyCronExpressions');
        return;
      }
